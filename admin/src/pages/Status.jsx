...
//     setLoading(true);
//     try {
//       const response = await axios.get("http://localhost:8000/api/admin/all-scholarships");
...
//                   <td className="px-4 py-2">{application.fatherName}</td>
//                   <td className="px-4 py-2">{application.aadharNumber}</td>
//                   <td className="px-4 py-2">{application.panNumber}</td>
//                   <td className="px-4 py-2">{application.tenthPercentage}%</td>
//                   <td className="px-4 py-2">{application.twelfthPercentage}%</td>
//                   <td className="px-4 py-2">{application.ugPercentage}%</td>
//                   <td className="px-4 py-2">{application.pgPercentage}%</td>
//                   <td className="px-4 py-2">{application.bankAccount}</td>
//                   <td className="px-4 py-2">{application.ifscCode}</td>
